...
<head>
    ...
    {{-- > //عملت كدا علشان اقوله علشان توصل للبلاج و الديست اوصل لاسم الدومين الاول وبعدين ادخل عليها لاني حاططهم في فولدر البابليك --}}
    <!-- Ionicons -->
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="{{url('dist/img/AdminLTELogo ')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                    style="opacity: .8">
